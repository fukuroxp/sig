            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav navbar-center mx-auto" id="navbar-navlist">
                        ...
                        <li class="nav-item">
                                <a data-scroll href="#services" class="nav-link">Wisata Populer</a>
                        </li>
                        <li class="nav-item">
                            <a data-scroll href="#pricing" class="nav-link">Tambah Lokasi</a>
                        </li>
                    </ul>
    ...
    <section class="section bg-services" id="services">
        <div class="container">
            ...
            <div class="row mt-5 pt-4 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="mt-4">
                        <img src="{{ asset('softlands/images/features/img-2.png') }}" class="img-fluid ps-4" alt="">
                    </div>
                </div>
                                    ...
                                    <div class="pricing-box rounded mt-4">
                                        <div class="text-center">
                                            ...
                                            <div class="pricing-img">
                                                <img src="{{ asset('softlands/images/features/img-3.png') }}" class="img-fluid" alt="">
                                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="pricing-box bg-lightan rounded mt-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted f-14">Per Month</p>
                                            <div class="pricing-img">
                                                <img src="{{ asset('softlands/images/features/img-4.png') }}" class="img-fluid" alt="">
                                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="pricing-box rounded mt-4">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted f-14">Per Month</p>
                                            <div class="pricing-img">
                                                <img src="{{ asset('softlands/images/features/img-5.png') }}" class="img-fluid" alt="">
                                            </div>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="client-box mt-4">
                                    <div class="client-img d-flex">
                                        <img src="{{ asset('softlands/images/users/img-1.jpg') }}" class="img-fluid rounded-circle" alt="">
                            ...
                            <div class="carousel-item">
                                <div class="client-box mt-4">
                                    <div class="client-img d-flex">
                                        <img src="{{ asset('softlands/images/users/img-2.jpg') }}" class="img-fluid rounded-circle" alt="">
                            ...
                            <div class="carousel-item">
                                <div class="client-box mt-4">
                                    <div class="client-img d-flex">
                                        <img src="{{ asset('softlands/images/users/img-3.jpg') }}" class="img-fluid rounded-circle" alt="">
                            ...
                            <div class="carousel-item">
                                <div class="client-box mt-4">
                                    <div class="client-img d-flex">
                                        <img src="{{ asset('softlands/images/users/img-4.jpg') }}" class="img-fluid rounded-circle" alt="">
                                        <div class="client-content ps-4">
                                            <h5 class="line-height_1_6 f-18">
                                                “I've learned that people will forget what you said, people will forget
                        ...
                        <div class="carousel-indicators mb-0">
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                <img src="{{ asset('softlands/images/users/img-1.jpg') }}" alt="" class=" testi-img img-fluid rounded mx-auto d-block">
                            </button>
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                                <img src="{{ asset('softlands/images/users/img-2.jpg') }}" alt="" class=" testi-img img-fluid rounded mx-auto d-block">
                            </button>
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                                <img src="{{ asset('softlands/images/users/img-3.jpg') }}" alt="" class=" testi-img img-fluid rounded mx-auto d-block">
                            </button>
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4">
                                <img src="{{ asset('softlands/images/users/img-4.jpg') }}" alt="" class=" testi-img img-fluid rounded mx-auto d-block">
                            </button>
                            </div>
                    </div>
                </div>
            ...
            <div class="row mt-5 pt-4">
                ...
                <div class="col-lg-6">
                    <div class="row align-items-center">
                        <div class="col-xl-7">
                            <div class="mt-4 blog-img">
                                <img src="{{ asset('softlands/images/blog/img-2.jpg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col-xl-5">
                            <div class="blog-content mt-4">
            ...
            <div class="row mt-3">
                <div class="col-lg-6">
                    <div class="row align-items-center">
                        <div class="col-xl-7">
                            <div class="mt-4 blog-img">
                                <img src="{{ asset('softlands/images/blog/img-3.jpg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col-xl-5">
                            <div class="blog-content mt-4">
                ...
                <div class="col-lg-6">
                    <div class="row align-items-center">
                        <div class="col-xl-7">
                            <div class="mt-4 blog-img">
                                <img src="{{ asset('softlands/images/blog/img-4.jpg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col-xl-5">
                            <div class="blog-content mt-4">
